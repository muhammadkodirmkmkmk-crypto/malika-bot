...
LOCATION_KEYWORDS = [
    # русский
    "локаци","адрес","где вы","где находит","офис","карта","маршрут","находитес",
    # узбекский латиница
    "manzil","lokatsiya","lakatsiya","lokatsia","qayerda","joylashuv","ofis",
    "xarita","yo'nalish","yonalish","qayer","joyi","joylar","qaerda",
    # узбекский кириллица (все варианты — с специальными буквами и без)
    "манзил","қаерда","каерда","харита","йўналиш","жойи","жойлар","жойилар",
    "қани","кани","офиси","офис",
    # английский
