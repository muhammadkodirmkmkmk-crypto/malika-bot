...
LOCATION_KEYWORDS = [
    # русский
    "локаци","адрес","где вы","где находит","офис","карта","карту","маршрут","находитес",
    "как доехать","куда приехать","добраться",
    # узбекский латиница
    "manzil","lokatsiya","lakatsiya","lokatsia","qayerda","joylashuv","ofis",
    "xarita","yo'nalish","yonalish","qayer","joyi","joylar","qaerda","adres",
    "qanday boramiz","boraman","koordinata","yo'l ko'rsat",
    # узбекский кириллица
    "манзил","қаерда","каерда","харита","йўналиш","жойи","жойлар","жойилар",
    "қани","кани","офиси","офис","жойлашув","йўл кўрсат","қандай борамиз",
    "координата",
    # английский
